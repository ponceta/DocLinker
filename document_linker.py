...
class DocumentLinker:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'DocumentLinker_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Document Linker')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'DocumentLinker')
        self.toolbar.setObjectName(u'DocumentLinker')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('DocumentLinker', message)
